...
ncc_hubs = [
  { name = "ai-dev", create = true, preset_topology = "MESH" },
  { name = "ai-qa", create = true },
  { name = "ai-prod", create = true },
]

transits = [
  {
    access_account_name = "lab-test-gcp"
    gw_name             = "gcp-us-east1-transit"
    project_id          = "rtrentin-01"
    region              = "us-east1"
    zone                = "us-east1-b"
    ha_zone             = "us-east1-c"
    name                = "us-east1-transit"
